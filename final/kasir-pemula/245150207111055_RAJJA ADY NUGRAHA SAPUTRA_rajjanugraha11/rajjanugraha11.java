...
public class kasikoko{ 
    public static void main(String[] args) { 
        ...
        double total1 = jumlahitem1 * hargaitem1 * (diskonitem1/100); 
        double total2 = jumlahitem2 * hargaitem2 * (diskonitem2/100); 
...
" x " + hargaitem1 + " - " + diskonitem1 + "%", total1); 
 
        System.out.println(namaitem2); 
        System.out.printf("%-20s%10.2f\n", jumlahitem2 + 
" x " + hargaitem2 + " - " + diskonitem2 + "%", total2); 
